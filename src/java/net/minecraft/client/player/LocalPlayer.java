...
import omg.sertyo.event.player.EventAction;
import omg.sertyo.event.player.EventMotion;
import omg.sertyo.event.player.EventUpdate;
...
public class LocalPlayer extends AbstractClientPlayer {
    ...
    public void tick() {
        if (this.level().hasChunkAt(this.getBlockX(), this.getBlockZ())) {
            EventUpdate eventUpdate = new EventUpdate(getX(), getY(), getZ(), getYRot(), getXRot(), onGround());
