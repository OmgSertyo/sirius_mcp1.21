...
public class GuiGraphics implements IForgeGuiGraphics {
    ...
    public void renderItemDecorations(Font pFont, ItemStack pStack, int pX, int pY, @Nullable String pText) {
        if (!pStack.isEmpty()) {
            ...
            float f3 = localplayer == null ? 0.0F : localplayer.getCooldowns().getCooldownPercent(pStack.getItem(), this.minecraft.getTimer().getGameTimeDeltaPartialTick(true));
            if (f3 > 0.0F) {
        ...
        if (!pComponents.isEmpty()) {
            ...
            if (Reflector.ForgeHooksClient_onRenderTooltipPre.exists()) {
                event = (Event)Reflector.ForgeHooksClient_onRenderTooltipPre
                    .call(this.tooltipStack, this, pMouseX, pMouseY, this.guiWidth(), this.guiHeight(), pComponents, pFont, pTooltipPositioner);
                if (event.isCanceled()) {
                    return;
                }
            }
            ...
            this.drawManaged(() -> {
                if (Reflector.ForgeHooksClient_onRenderTooltipColor.exists()) {
                    Object object = Reflector.ForgeHooksClient_onRenderTooltipColor.call(this.tooltipStack, this, l, i1, font, pComponents);
